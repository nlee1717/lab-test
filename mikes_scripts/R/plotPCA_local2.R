...
setwd('C:/kutluaylab/data/Vero/rnaseq/Vero_rnaseq_counts/') # with slash in the end
expname <- 'Vero_rseq_mockonly' # prefix for naming the output png
output_dir <- "C:/kutluaylab/data/Vero/rnaseq/PCA/" # with slash, output directory
