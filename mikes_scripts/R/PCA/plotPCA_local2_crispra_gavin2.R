...
setwd('C:/kutluaylab/data/CRISPR_GFP_screen/second_screen/mageck/count/count_total/') # with slash in the end
expname <- 'gavin2' # prefix for naming the output png
output_dir <- "C:/kutluaylab/data/CRISPR_GFP_screen/second_screen/PCA/" # with slash, output directory
...
data_selected <- raw_count[, str_detect(string = colnames(raw_count), pattern = "sort")]
